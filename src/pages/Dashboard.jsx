          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center">
              <img
                ...
                className="avatar mr-2 ring-2 ring-primary-500 ring-offset-2 ring-offset-white dark:ring-offset-gray-800"
              />
            ...
            <button
              ...
              className="btn-secondary flex items-center text-sm hover:bg-gray-300 dark:hover:bg-gray-600"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-3 w-full md:w-auto">
                <div className="relative w-full sm:w-64">
                  ...
                  <input
                    ...
                    className="input-field pl-10 focus:ring-primary-500 focus:border-primary-500 transition-all duration-300"
                  />
                </div>
                
                <button
                  onClick={() => setShowCreateRoom(true)}
                  className="btn-primary flex items-center text-sm w-full sm:w-auto justify-center shadow-lg shadow-primary-500/20"
                  disabled={!connected}
                >
              ...
              >
                ...
                >
                  <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white flex items-center">
                    <FiPlus className="mr-2 text-primary-500" />
                    Create New Room
                  </h3>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className="input-field focus:ring-primary-500 focus:border-primary-500 transition-all duration-300"
                  ...
                  <div className="flex justify-end space-x-3">
                    <button
                      onClick={() => setShowCreateRoom(false)}
                      className="btn-secondary hover:bg-gray-300 dark:hover:bg-gray-600"
                    >
                      Cancel
                    </button>
                    <button
              ...
              {filteredRooms && filteredRooms.length > 0 ? (
                filteredRooms.map((room) => (
                  <motion.div
                    ...
                    className="card hover:shadow-xl cursor-pointer transform hover:scale-105 transition-all duration-300 overflow-hidden border-gray-200 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-700 group"
                    onClick={() => handleJoinRoom(room.id)}
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-primary-500/10 to-primary-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                    <div className="p-5">
                ...
                <div className="col-span-full bg-white dark:bg-gray-800 rounded-lg p-8 text-center text-gray-500 dark:text-gray-400 shadow-md border border-gray-200 dark:border-gray-700">
                  {!connected ? (
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
              <div className="p-3 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                  ...
                  {users.map((user) => (
                    ...
                    >
                      <img
                        src={user.avatar}
                        alt={user.username}
                        className="h-10 w-10 rounded-full mr-3 border-2 border-white dark:border-gray-800 shadow-sm"
                      />
                      <div>
